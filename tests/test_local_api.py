...
def test_local_api():
    ...
    payload = {
        ...
        'Tongue\t': 1,
        'Body frame (Length)\t': 1,
        'Body frame (Breadth)\t': 1,
        'Bodyweight changes\t': 1,
        'Style of speaking\t': 1,
        'Voice \t': 1,
        'Walk \t': 1,
        'Appetite \t ': 1,
        'Intensity of hunger\t': 1,
        'Favorite climate\t': 1,
        'Stamina\t': 1,
        'Tastes, I like most': 1,
        'Eagerness about drinking water': 1,
        'Frequency of liquid intake\t': 1,
        'Sleep\t': 1,
        'Quantity of sweat\t': 1,
        'Emotion\t': 1,
        'Intellect\t': 1,
        ...
        'Temperament\t': 1,
        'Patience\t': 1,
        'Satisfaction/content\t': 1,
        'While making decisions\t': 1,
        'Activities\t': 1,
        'Nature of dreams\t': 1,
        'Friendships & relations\t': 1,
        'Faith in God\t': 1,
        'Self-control\t': 1,
        'Gratefulness\t': 1,
        'Likings\t': 1,
        'Liking- type of food': 1,
        'Politeness/humbleness': 1,
        'Biting nails ': 1,
        'Fond of praise ': 1,
        'Brave': 1,
        'Egoistic': 1
